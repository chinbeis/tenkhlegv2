      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-8 rounded-lg shadow-lg text-center transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-2xl font-bold mb-2 text-gray-800">{t.address_title}</h3>
            <p className="text-blue-600 font-medium">{t.address_value}</p>
            <p className="text-gray-500 mt-2">{t.address_description}</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-lg text-center transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-2xl font-bold mb-2 text-gray-800">{t.phone_title}</h3>
            <p className="text-blue-600 font-medium">{t.phone_value}</p>
            <p className="text-gray-500 mt-2">{t.phone_description}</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-lg text-center transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-2xl font-bold mb-2 text-gray-800">{t.email_title}</h3>
            <p className="text-blue-600 font-medium">{t.email_value}</p>
            <p className="text-gray-500 mt-2">{t.email_description}</p>
          </div>
        </div>

        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">{t.form_title}</h2>
            <form>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">{t.map_title}</h2>
