...
const ResortRooms = () => {
  ...
  const t = (key: string) => translate(`RoomsPage.resort_rooms.${key}`);
  const roomKeys = ["one_bed", "two_bed", "public", "public_large", "lux_1", "lux_2", "standard"];
  const roomImages: { [key: string]: string } = {
    "one_bed": "/images/menus/resort/1bed.jpg",
    "two_bed": "/images/menus/resort/2bed.jpg",
    "public": "/images/menus/resort/big1.jpg",
    "public_large": "/images/menus/resort/big2.jpg",
    "lux_1": "/images/menus/resort/lux1.jpg",
    "lux_2": "/images/menus/resort/lux2.jpg",
    "standard": "/images/menus/resort/standart.jpg",
  };
